...
function testcase_athena.plugins.php.get_supported_php_versions()
{
	...
	bashunit.test.mock.outputs "athena.plugin.get_plg_docker_dir" "$fake_docker_dir"
	bashunit.test.assert_output "athena.plugins.php.get_supported_php_versions" "php7.0"
	bashunit.test.assert_output.expects_fail "athena.plugins.php.get_supported_php_versions" "garbage, php7.0"
...
function testcase_athena.plugins.php.set_php_version()
{
	...
	bashunit.test.assert_output "athena.plugins.php.set_php_version" "php7.0" "7.0"
}
